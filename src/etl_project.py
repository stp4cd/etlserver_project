...
def etl_sub():
    ...
    # convert the 2006 data to JSON and write to a file
    json_year = usa_medals_year.to_json(orient = 'records')
    print(json_year)
    
    # writing USA 2006 data to a file
